...
//SCENE
var floor, brid1, bird2, birdSize;
...
Bird = function(){
  ...
  var wingGeom = new THREE.BoxGeometry(20,60, 100);
  ...
  var eyeGeom = new THREE.CircleGeometry(60,50,10);
  var secondeyeGeom = new THREE.CircleGeometry(30,30,10);
  var irisGeom = new THREE.CircleGeometry(20,100,100);

  this.leftEye = new THREE.Mesh(eyeGeom, this.yellowMat);
  this.leftEye.position.x = -40;
  this.leftEye.position.y = 150;
  this.leftEye.position.z = 18;
  this.leftEye.rotation.y = -Math.PI/5;

  this.leftSecondEye = new THREE.Mesh(secondeyeGeom, this.whiteMat);
  this.leftSecondEye.position.x = -30;
  this.leftSecondEye.position.y = 120;
  this.leftSecondEye.position.z = 38;
  this.leftSecondEye.rotation.y = -Math.PI/5;
  ...
  this.leftIris.rotation.y = -Math.PI/5;


  this.rightEye = new THREE.Mesh(eyeGeom, this.yellowMat);
  this.rightEye.position.x = 40;
  this.rightEye.position.y = 150;
  this.rightEye.position.z = 18;
  this.rightEye.rotation.y = Math.PI/5;

  this.rightSecondEye = new THREE.Mesh(secondeyeGeom, this.whiteMat);
  this.rightSecondEye.position.x = 30;
  this.rightSecondEye.position.y = 120;
  this.rightSecondEye.position.z = 38;
  this.rightSecondEye.rotation.y = Math.PI/5;
  ...
  this.rightIris.rotation.y = Math.PI/5;

  // BEAK

  var beakGeom = new THREE.CylinderGeometry(0,13,10, 4,1);
  this.beak = new THREE.Mesh(beakGeom, this.orangeMat);
  this.beak.position.z = 70;
  this.beak.position.y = -100;
  this.beak.rotation.x = Math.PI/2;

  this.face.add(this.rightEye);
  this.face.add(this.rightIris);
  this.face.add(this.rightSecondEye);
  this.face.add(this.leftEye);
  this.face.add(this.leftIris);
  this.face.add(this.leftSecondEye);
...
Bird.prototype.look = function(hAngle,vAngle){
  ...
  this.leftIris.position.y = 120 - this.vAngle*35;
  this.leftIris.position.x = -30 + this.hAngle*10;
  this.leftIris.position.z = 42 + this.hAngle*10;

  this.leftSecondEye.position.y = 120 - this.vAngle*30;
  this.leftSecondEye.position.x = -30 + this.hAngle*10;
  this.leftSecondEye.position.z = 40 + this.hAngle*10;

  this.rightIris.position.y = 120 - this.vAngle*30;
  this.rightIris.position.x = 30 + this.hAngle*10;
  this.rightIris.position.z = 42 - this.hAngle*10;

  this.rightSecondEye.position.y = 120 - this.vAngle*30;
  this.rightSecondEye.position.x = 30 + this.hAngle*10;
  this.rightSecondEye.position.z = 40 - this.hAngle*10;

  this.leftEye.position.y = this.rightEye.position.y = 120 - this.vAngle*10;

  this.beak.position.y = 100 - this.vAngle*50;
...
function createFloor(){
  floor = new THREE.Mesh(new THREE.PlaneBufferGeometry(400,400), new THREE.MeshBasicMaterial({color: 0xCDEDCE}))
